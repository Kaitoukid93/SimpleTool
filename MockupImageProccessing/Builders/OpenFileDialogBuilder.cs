...
namespace MockupImageProccessing.Builders;
...
public class OpenFileDialogBuilder
{
    ...
    {
        _options.SuggestedStartLocation = directory != null
            ? _parent.StorageProvider.TryGetFolderFromPathAsync(directory).GetAwaiter().GetResult()
            : null;
        return this;
    }
